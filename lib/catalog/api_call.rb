...
module Figo
  ...
  #
  # @param country[String] Two-letter country code. Show only resources within this country. Country code is case-sensitve.
  # @param q [String] Query for the entire catalog. Will match banks on domestic bank code, BIC, name or figo-ID.
